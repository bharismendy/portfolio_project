...
def context_general():
    ...
    list_cat_5 = Categorie.objects.filter(niv_cat=5).order_by('nom_categorie')
    list_cat_6 = Categorie.objects.filter(niv_cat=6).order_by('nom_categorie')

    return {"cat_niv_1": list_cat_1,
            "cat_niv_2": list_cat_2,
            "cat_niv_3": list_cat_3,
            "cat_niv_4": list_cat_4,
            "cat_niv_5": list_cat_5,
            "cat_niv_6": list_cat_6}
